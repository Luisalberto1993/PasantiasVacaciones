    ...
    <div id="wrapper">
        ...
        <div class="container-fluid body-section">
            <div class="row">
                ...
                <div class="col-md-9">
                    <h1><i class="fa fa-database"></i> Imagen <small>Agregar o ver Imagenes</small></h1><hr>
                    <ol class="breadcrumb">
                        <li><a href="index.php"><i class="fa fa-tachometer"></i> Menú</a></li>
                        <li class="active"><i class="fa fa-database"></i> Imagenes</li>
                    </ol>
                    <?php
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="col-sm-4 col-xs-4">
                                <input type="submit" name="submit" class="btn btn-primary btn-sm" value="Agregar Imagen">
                            </div>
                        </div>
                    </form><hr>
