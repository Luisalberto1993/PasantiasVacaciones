...
<?php require_once('inc/header.php');?>
        ...
        <div class="container-fluid body-section">
            <div class="row">
                ...
                <div class="col-md-9">
                    <h1><i class="fa fa-pencil"></i> Editar Post <small>Editar Detalles de Post</small></h1><hr>
                    <ol class="breadcrumb">
                      <li><a href="index.php"><i class="fa fa-tachometer"></i> Menu</a></li>
                      <li class="active"><i class="fa fa-pencil"></i> Editar Post</li>
                    </ol>
                    <?php
                        ...
                        <div class="col-xs-12">
                            <form action="" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    ?>
                                    <input type="text" name="title" placeholder="Ingresar titulo del post" value="<?php if(isset($title)){echo $title;}?>" class="form-control">
                                </div>
                                
                                <div class="form-group">
                                    <a href="media.php" class="btn btn-primary">Añadir Imagen</a>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="categories">Cateogorías:*</label>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="tags" placeholder="Ingresar etiquetas" value="<?php if(isset($tags)){echo $tags;}?>" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="status" id="status">
                                                <option value="publish" <?php if(isset($status) and $status == 'publish'){echo "selected";}?>>Publico</option>
                                                <option value="draft" <?php if(isset($status) and $status == 'draft'){echo "selected";}?>>Draft</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                <input type="submit" class="btn btn-primary" value="Actualizar Post" name="update">
                            </form>
                        </div>
                    </div>
                </div>
