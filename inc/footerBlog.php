<section class="footer" id="footer">
    <div class="container">
        ...
        <p>&copy; Fábrica Ideas. Todos los derechos Reservados.</p>
        <div class="credits">

            <a href="index.php">Realizado</a> por <a href="https://www.facebook.com/">Fábrica Ideas <?php echo date('Y'); ?></a>
        </div>
    </div>
</section>

<script src="js/bootstrap.min.js"></script>
<!--  para la pagina inicial//smooth scrolling -->
