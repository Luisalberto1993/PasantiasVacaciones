    ...
    <div id="wrapper">
        ...
        <div class="container-fluid body-section">
            <div class="row">
                ...
                <div class="col-md-9">
                    <h1><i class="fa fa-plus-square"></i> Agregar Post <small> Agregar nuevo </small></h1><hr>
                    <ol class="breadcrumb">
                        <li><a href="index.php"><i class="fas fa-home"></i> Menú</a></li>
                        <li class="active"> <i class="fa fa-plus-square"></i> Agregar Noticia</li>
                    </ol>
                    <?php
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <form action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <a href="media.php" class="btn btn-primary">Agregar Imagen</a>
                                </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="status" id="status">
                                                ...
                                                if (isset($status) and $status == 'publish') {
                                                    echo "selected";
                                                }
                                                ?>>Publicar</option>
                                                <option value="draft" <?php
                                                if (isset($status) and $status == 'draft') {
                                                    echo "selected";
                                                }
                                                ?>>Draft</option>
                                            </select>
                                ...
                                <input type="submit" class="btn btn-primary" value="Agregar Post" name="submit">
                            </form>
                        </div>
                    </div>
                </div>
